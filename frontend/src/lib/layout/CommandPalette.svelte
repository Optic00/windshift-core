<script>
  ...
  function getBaseCommands() {
    ...
    const commands = [
      ...
      { id: 'admin-condition-sets', label: t('commandPalette.commands.adminConditionSets.label'), description: t('commandPalette.commands.adminConditionSets.description'), url: '/admin/condition-sets', action: () => navigateToAdminTab('condition-sets'), keywords: ['admin', 'condition', 'sets', 'workflow', 'transitions', 'restrictions', 'acs'], isAdmin: true },
      ...
      { id: 'admin-email-templates', label: t('commandPalette.commands.adminEmailTemplates.label', 'Email Templates'), description: t('commandPalette.commands.adminEmailTemplates.description', 'Customize transactional email subject and body'), url: '/admin/email-templates', action: () => navigateToAdminTab('email-templates'), keywords: ['admin', 'email', 'templates', 'transactional', 'magic', 'invitation', 'verification', 'aet'], isAdmin: true },

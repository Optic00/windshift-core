...
export default {
  settings: {
    ...
    themeManager: {
      background: 'Hintergrund', text: 'Text',
      failedToLoad: 'Themes konnten nicht geladen werden.', failedToCreate: 'Theme konnte nicht erstellt werden.',
      failedToUpdate: 'Theme konnte nicht aktualisiert werden.', failedToDelete: 'Theme konnte nicht gelöscht werden.',
      failedToActivate: 'Theme konnte nicht aktiviert werden.',
      defaults: {
        default: { name: 'Standard', description: 'Klares Theme mit Standardfarben für die Navigation' },
        ocean: { name: 'Ozean', description: 'Professionelles Navigationstheme in Blautönen' },
        forest: { name: 'Wald', description: 'Von der Natur inspiriertes grünes Navigationstheme' },
      },
    },
    ...
    configSets: {
      ...
      customScreenOverrides: '{count} benutzerdefiniert',
      importSuccess: 'Konfigurationsset erfolgreich importiert',
      import: 'Importieren',
      importing: 'Wird importiert…',
      importWarning: 'Das Konfigurationsset wurde mit Warnungen importiert.',
      importFailed: 'Das Konfigurationsset konnte nicht importiert werden.',
      unresolvedReferencesHeading: 'Der Import verweist auf Entitäten, die auf dieser Instanz nicht vorhanden sind.',
      defaultConflictHeading: 'Der Import steht in Konflikt mit einer Standardentität dieser Instanz.',
      unresolvedImportTitle: 'Import: nicht aufgelöste Verweise',
      unresolvedImportDescription: 'Es wurden keine Daten geschrieben. Entfernen Sie diese Verweise aus dem Quellpaket oder erstellen Sie die fehlenden Entitäten und versuchen Sie es erneut.',
      referenceLocation: 'Bei {path}',
      unresolvedKinds: {
        user: 'Benutzer {name}', role: 'Rolle „{name}“', group: 'Gruppe „{name}“',
        status_category: 'Statuskategorie „{name}“', entity: 'Entität „{name}“',
      },
      export: 'Exportieren',
      exportTitle: 'Dieses Konfigurationsset als übertragbare JSON-Vorlage exportieren',
      exportDefaultDisabled: 'Das Standard-Konfigurationsset kann nicht exportiert werden. Klonen Sie es zuerst, wenn Sie eine übertragbare Kopie benötigen.',
      defaults: {
        configuration: { name: 'Standardkonfiguration', description: 'Standard-Konfigurationsset mit grundlegendem Workflow und Standardmaske' },
        notifications: { name: 'Standardbenachrichtigungen', description: 'Standardregeln für Benachrichtigungen zu Aufgabenaktualisierungen' },
      },
    ...
    sso: {
      ...
      trustIdpEmailVerification: 'Vom Anbieter verwalteten E-Mail-Adressen vertrauen',
      trustIdpEmailVerificationDesc: 'Windshift-E-Mail-Verifizierung überspringen, wenn dieser Anbieter keinen Verifizierungsstatus übermittelt. Ausdrücklich als unverifiziert gemeldete Adressen müssen weiterhin verifiziert werden.',
      idpVerificationNotEnforced: 'Windshift verifiziert unbestätigte E-Mail-Adressen',
      unsafeProvisioningWarningTitle: 'Vertrauen in Anbieter-E-Mail aktiviert',
      unsafeProvisioningWarningBody:
        'Benutzer können über die E-Mail-Adresse mit bestehenden Konten verknüpft werden, wenn der Anbieter keinen Verifizierungsstatus übermittelt. Nur aktivieren, wenn der Anbieter die E-Mail-Adressen seiner Benutzer kontrolliert.',
    ...
    linkTypes: {
      ...
      namePlaceholder: 'z. B. Implementiert',
      forwardPlaceholder: 'z. B. implementiert',
      reversePlaceholder: 'z. B. implementiert von',
      forwardHint: 'Wenn A mit B verknüpft ist, als „A implementiert B“ anzeigen',
      reverseHint: 'Wenn B von A verknüpft wird, als „B implementiert von A“ anzeigen',
      descriptionPlaceholder: 'Optionale Beschreibung dieses Verknüpfungstyps',
      empty: 'Keine Verknüpfungstypen gefunden. Erstellen Sie den ersten Typ für Beziehungen zwischen Einträgen.',
      defaults: {
        tests: { name: 'Testet', description: 'Testfall testet einen Arbeitsvorgang' },
        implements: { name: 'Implementiert', description: 'Arbeitsvorgang implementiert einen anderen Arbeitsvorgang' },
        dependsOn: { name: 'Abhängig von', description: 'Arbeitsvorgang hängt von einem anderen Arbeitsvorgang ab' },
        relatesTo: { name: 'Bezieht sich auf', description: 'Allgemeine bidirektionale Beziehung' },
        linksTo: { name: 'Verknüpft mit', description: 'Allgemeine gerichtete Verknüpfung' },
        duplicates: { name: 'Dupliziert', description: 'Arbeitsvorgang ist ein Duplikat eines anderen' },
        childOf: { name: 'Untergeordnet zu', description: 'Alternative Hierarchiebeziehung' },
        page: { name: 'Seite', description: 'Arbeitsvorgang verweist auf eine Wissensseite' },
      },
    },
    statusCategories: {
      ...
      confirmDelete: 'Statuskategorie „{name}“ löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
      count: 'Kategorien: {count}',
    ...
    itemTypes: {
      ...
      nameRequired: 'Name ist erforderlich',
      failedToLoad: 'Vorgangstypen konnten nicht geladen werden.',
      failedToSave: 'Vorgangstyp konnte nicht gespeichert werden.',
      deleteFailed: 'Vorgangstyp konnte nicht gelöscht werden.',
      ...
      noConfigurationSets: 'Keine Konfigurationssets',
      defaultConfiguration: 'Standardkonfiguration',
      namePlaceholder: 'z. B. Epic, Story, Aufgabe, Fehler',
      descriptionPlaceholder: 'Kurze Beschreibung dieses Vorgangstyps',
      levelLabel: 'Ebene {level} — {name}',
      levelOnly: 'Ebene {level}',
      levelOption: '{name} (Ebene {level})',
      defaults: {
    ...
    hierarchyLevels: {
      ...
      failedToLoad: 'Hierarchieebenen konnten nicht geladen werden.',
      failedToSave: 'Hierarchieebene konnte nicht gespeichert werden.',
      deleteFailed: 'Hierarchieebene konnte nicht gelöscht werden.',
      cannotDeleteTitle: 'Hierarchieebene kann nicht gelöscht werden',
      levelOccupied: 'Ebene {level} ist bereits mit „{name}“ belegt.',
      negativeLevel: 'Eine Hierarchieebene kann nicht unter 0 verschoben werden.',
      empty: 'Noch keine Hierarchieebenen konfiguriert.',
      numericHint: 'Numerische Hierarchieebene (0 = höchste Ebene)',
      namePlaceholder: 'z. B. Initiative, Epic, Story, Aufgabe',
      descriptionPlaceholder: 'Kurze Beschreibung dieser Hierarchieebene',
      createTitle: 'Hierarchieebene erstellen',
      editTitle: 'Hierarchieebene bearbeiten',
      confirmDelete: '„{name}“ löschen?',
      defaults: {
        initiative: {
          name: 'Initiative',
          description: 'Strategische Arbeit auf oberster Ebene, die mehrere Epics umfasst',
        },
        epic: {
          name: 'Epic',
          description: 'Großer Arbeitsvorgang, der in Storys unterteilt werden kann',
        },
        story: {
          name: 'Story',
          description: 'User Story oder Funktion, die einen Mehrwert liefert',
        },
        task: {
          name: 'Aufgabe',
          description: 'Einzelner Arbeitsvorgang oder technische Aufgabe',
        },
        activity: {
          name: 'Aktivität',
          description: 'Einzelne Aktivität innerhalb einer Aufgabe',
        },
      },
    },
    modules: {

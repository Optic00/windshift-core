...
export default {
  settings: {
    ...
    themeManager: {
      background: 'Fondo', text: 'Texto',
      failedToLoad: 'No se pudieron cargar los temas.', failedToCreate: 'No se pudo crear el tema.',
      failedToUpdate: 'No se pudo actualizar el tema.', failedToDelete: 'No se pudo eliminar el tema.',
      failedToActivate: 'No se pudo activar el tema.',
      defaults: {
        default: { name: 'Predeterminado', description: 'Tema limpio con colores de navegación estándar' },
        ocean: { name: 'Océano', description: 'Tema de navegación profesional en tonos azules' },
        forest: { name: 'Bosque', description: 'Tema de navegación verde inspirado en la naturaleza' },
      },
    },
    ...
    configSets: {
      ...
      importWarning: 'El conjunto de configuración se importó con advertencias.',
      importFailed: 'No se pudo importar el conjunto de configuración.',
      unresolvedReferencesHeading: 'La importación hace referencia a entidades que no existen en esta instancia.',
      defaultConflictHeading: 'La importación entra en conflicto con una entidad predeterminada de esta instancia.',
      unresolvedImportTitle: 'Importación: referencias sin resolver',
      unresolvedImportDescription: 'No se escribió ningún dato. Elimine estas referencias del paquete de origen o cree aquí las entidades que faltan y vuelva a intentarlo.',
      referenceLocation: 'En {path}',
      unresolvedKinds: {
        user: 'Usuario {name}', role: 'Rol «{name}»', group: 'Grupo «{name}»',
        status_category: 'Categoría de estado «{name}»', entity: 'Entidad «{name}»',
      },
      export: 'Exportar',
      exportTitle: 'Exportar este conjunto de configuración como plantilla JSON portátil',
      exportDefaultDisabled: 'El conjunto de configuración predeterminado no se puede exportar. Clónelo primero si necesita una copia portátil.',
      defaults: {
        configuration: { name: 'Configuración predeterminada', description: 'Conjunto de configuración predeterminado con flujo de trabajo y pantalla básicos' },
        notifications: { name: 'Notificaciones predeterminadas', description: 'Reglas de notificación estándar para actualizaciones de elementos de trabajo' },
      },
    ...
    sso: {
      ...
      trustIdpEmailVerification: 'Confiar en los correos gestionados por el proveedor',
      trustIdpEmailVerificationDesc: 'Omite la verificación de Windshift cuando este proveedor no informa del estado de verificación. Las direcciones marcadas explícitamente como no verificadas aún deben verificarse.',
      idpVerificationNotEnforced: 'Windshift verifica los correos no confirmados',
      unsafeProvisioningWarningTitle: 'Confianza en el correo del proveedor activada',
      unsafeProvisioningWarningBody:
        'Los usuarios cuyo proveedor omita la verificación pueden vincularse por correo con cuentas existentes. Actívalo solo si el proveedor controla las direcciones de correo de sus usuarios.',
    ...
    linkTypes: {
      ...
      nameRequired: 'El nombre es obligatorio',
      failedToSave: 'No se pudo guardar el tipo de enlace.',
      namePlaceholder: 'p. ej., Implementa',
      forwardPlaceholder: 'p. ej., implementa',
      reversePlaceholder: 'p. ej., implementado por',
      forwardHint: 'Cuando A enlaza con B, mostrar como «A implementa B»',
      reverseHint: 'Cuando B recibe un enlace de A, mostrar como «B implementado por A»',
      descriptionPlaceholder: 'Descripción opcional de este tipo de relación',
      empty: 'No se encontraron tipos de enlaces. Crea el primero para habilitar relaciones entre elementos.',
      defaults: {
        tests: { name: 'Prueba', description: 'El caso de prueba comprueba el elemento de trabajo' },
        implements: { name: 'Implementa', description: 'El elemento de trabajo implementa otro elemento' },
        dependsOn: { name: 'Depende de', description: 'El elemento de trabajo depende de otro elemento' },
        relatesTo: { name: 'Relacionado con', description: 'Relación bidireccional general' },
        linksTo: { name: 'Enlaza con', description: 'Enlace direccional general' },
        duplicates: { name: 'Duplica', description: 'El elemento de trabajo es un duplicado de otro' },
        childOf: { name: 'Secundario de', description: 'Relación jerárquica alternativa' },
        page: { name: 'Página', description: 'El elemento de trabajo hace referencia a una página de conocimiento' },
      },
    },
    statusCategories: {
      ...
      nameRequired: 'El nombre es obligatorio',
      failedToSave: 'No se pudo guardar la categoría de estado.',
      failedToDelete: 'No se pudo eliminar la categoría de estado.',
      confirmDelete: '¿Eliminar la categoría de estado «{name}»? Esta acción no se puede deshacer.',
      count: 'Categorías: {count}',
      statusCount: 'Estados: {count}',
    ...
    itemTypes: {
      ...
      nameRequired: 'El nombre es obligatorio',
      failedToLoad: 'No se pudieron cargar los tipos de elementos.',
      failedToSave: 'No se pudo guardar el tipo de elemento.',
      deleteFailed: 'No se pudo eliminar el tipo de elemento.',
      confirmDelete: '¿Eliminar «{name}»? Esta acción no se puede deshacer.',
      noItemTypes: 'Aún no hay tipos de elementos configurados.',
      noConfigurationSets: 'Sin conjuntos de configuración',
      defaultConfiguration: 'Configuración predeterminada',
      namePlaceholder: 'p. ej., Épica, Historia, Tarea, Error',
      descriptionPlaceholder: 'Breve descripción de este tipo de elemento',
      levelLabel: 'Nivel {level} — {name}',
      levelOnly: 'Nivel {level}',
      levelOption: '{name} (nivel {level})',
      defaults: {
    ...
    hierarchyLevels: {
      ...
      failedToLoad: 'No se pudieron cargar los niveles de jerarquía.',
      failedToSave: 'No se pudo guardar el nivel de jerarquía.',
      deleteFailed: 'No se pudo eliminar el nivel de jerarquía.',
      cannotDeleteTitle: 'No se puede eliminar el nivel de jerarquía',
      levelOccupied: 'El nivel {level} ya está ocupado por «{name}».',
      negativeLevel: 'Un nivel de jerarquía no puede moverse por debajo de 0.',
      empty: 'Todavía no hay niveles de jerarquía configurados.',
      numericHint: 'Nivel numérico de jerarquía (0 = el más alto)',
      namePlaceholder: 'p. ej., Iniciativa, Épica, Historia, Tarea',
      descriptionPlaceholder: 'Breve descripción de este nivel de jerarquía',
      createTitle: 'Crear nivel de jerarquía',
      editTitle: 'Editar nivel de jerarquía',
      confirmDelete: '¿Eliminar «{name}»?',
      defaults: {
        initiative: {
          name: 'Iniciativa',
          description: 'Trabajo estratégico de alto nivel que abarca varias épicas',
        },
        epic: {
          name: 'Épica',
          description: 'Elemento de trabajo grande que puede dividirse en historias',
        },
        story: {
          name: 'Historia',
          description: 'Historia de usuario o función que aporta valor',
        },
        task: {
          name: 'Tarea',
          description: 'Elemento de trabajo individual o tarea técnica',
        },
        activity: {
          name: 'Actividad',
          description: 'Actividad concreta dentro de una tarea',
        },
      },
    },
    modules: {

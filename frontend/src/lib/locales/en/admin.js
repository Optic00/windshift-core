  ...
  settings: {
    ...
    themeManager: {
      ...
      defaults: {
        ...
        forest: { name: 'Forest', description: 'Nature-inspired green navigation theme' },
      },
    },
    ...
    configSets: {
      ...
      customScreenOverrides: '{count} custom',
      importSuccess: 'Configuration set imported successfully',
      import: 'Import',
      importing: 'Importing…',
      importWarning: 'The configuration set was imported with warnings.',
      importFailed: 'Failed to import the configuration set.',
      unresolvedReferencesHeading: 'The import references entities that do not exist on this instance.',
      defaultConflictHeading: 'The import conflicts with a default entity on this instance.',
      unresolvedImportTitle: 'Import: unresolved references',
      unresolvedImportDescription: 'Nothing was written. Remove these references from the source bundle or create the missing entities here, then retry.',
      referenceLocation: 'At {path}',
      unresolvedKinds: {
        user: 'User {name}', role: 'Role “{name}”', group: 'Group “{name}”',
        status_category: 'Status category “{name}”', entity: 'Entity “{name}”',
      },
      export: 'Export',
      exportTitle: 'Export this configuration set as a portable JSON template',
      exportDefaultDisabled: 'The default configuration set cannot be exported. Clone it first if you need a portable copy.',
      defaults: {
        configuration: { name: 'Default Configuration', description: 'Default configuration set with basic workflow and screen' },
        notifications: { name: 'Default Notifications', description: 'Standard notification rules for work item updates' },
      },
    ...
    linkTypes: {
      ...
      namePlaceholder: 'e.g. Implements',
      forwardPlaceholder: 'e.g. implements',
      reversePlaceholder: 'e.g. implemented by',
      forwardHint: 'When A links to B, show as “A implements B”',
      reverseHint: 'When B is linked from A, show as “B implemented by A”',
      descriptionPlaceholder: 'Optional description of this relationship type',
      empty: 'No link types found. Create your first link type to enable item relationships.',
      defaults: {
        tests: { name: 'Tests', description: 'Test case tests work item' },
        implements: { name: 'Implements', description: 'Work item implements another work item' },
        dependsOn: { name: 'Depends On', description: 'Work item depends on another work item' },
        relatesTo: { name: 'Relates To', description: 'General bidirectional relationship' },
        linksTo: { name: 'Links To', description: 'General directional link' },
        duplicates: { name: 'Duplicates', description: 'Work item is a duplicate of another' },
        childOf: { name: 'Child Of', description: 'Alternative hierarchy relationship' },
        page: { name: 'Page', description: 'Work item references a knowledge page' },
      },
    },
    ...
    statusCategories: {
      ...
      confirmDelete: 'Delete the status category “{name}”? This action cannot be undone.',
    ...
    itemTypes: {
      ...
      nameRequired: 'Name is required',
      failedToLoad: 'Failed to load item types.',
      failedToSave: 'Failed to save item type.',
      deleteFailed: 'Failed to delete item type.',
      confirmDelete: 'Delete “{name}”? This action cannot be undone.',
      noItemTypes: 'No item types configured yet.',
      noConfigurationSets: 'No configuration sets',
      defaultConfiguration: 'Default Configuration',
      namePlaceholder: 'e.g. Epic, Story, Task, Bug',
      descriptionPlaceholder: 'Brief description of this item type',
      levelLabel: 'Level {level} — {name}',
      levelOnly: 'Level {level}',
      levelOption: '{name} (Level {level})',
      defaults: {
    ...
    hierarchyLevels: {
      ...
      failedToLoad: 'Failed to load hierarchy levels.',
      failedToSave: 'Failed to save hierarchy level.',
      deleteFailed: 'Failed to delete hierarchy level.',
      cannotDeleteTitle: 'Cannot delete hierarchy level',
      levelOccupied: 'Level {level} is already occupied by “{name}”.',
      negativeLevel: 'A hierarchy level cannot be moved below 0.',
      empty: 'No hierarchy levels configured yet.',
      numericHint: 'Numeric hierarchy level (0 = highest)',
      namePlaceholder: 'e.g. Initiative, Epic, Story, Task',
      descriptionPlaceholder: 'Brief description of this hierarchy level',
      createTitle: 'Create hierarchy level',
      editTitle: 'Edit hierarchy level',

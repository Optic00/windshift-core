...
export default {
  settings: {
    ...
    themeManager: {
      background: 'الخلفية', text: 'النص',
      failedToLoad: 'تعذر تحميل السمات.', failedToCreate: 'تعذر إنشاء السمة.',
      failedToUpdate: 'تعذر تحديث السمة.', failedToDelete: 'تعذر حذف السمة.',
      failedToActivate: 'تعذر تفعيل السمة.',
      defaults: {
        default: { name: 'افتراضي', description: 'سمة بسيطة بألوان تنقل قياسية' },
        ocean: { name: 'المحيط', description: 'سمة تنقل احترافية بدرجات اللون الأزرق' },
        forest: { name: 'الغابة', description: 'سمة تنقل خضراء مستوحاة من الطبيعة' },
      },
    },
    admin: 'الإدارة',
    ...
    configSets: {
      ...
      previewUnavailable: 'لا تتوفر مجموعة تكوين',
      previewUnavailableDescription: 'أنشئ مجموعة تكوين افتراضية لإعداد مساحة العمل هذه.',
      assignerDescription: 'اختر مجموعة التكوين التي تحدد سير العمل وشاشات إنشاء العناصر وتعديلها وعرضها في مساحة العمل هذه. يمكن تعيين مجموعة واحدة فقط.',
      select: 'اختيار مجموعة التكوين',
      updating: 'جارٍ تحديث التكوين…',
      configured: 'تم التكوين',
      customScreenOverrides: '{count} مخصصة',
      importSuccess: 'تم استيراد مجموعة التكوين بنجاح',
      import: 'استيراد',
      importing: 'جارٍ الاستيراد…',
      importWarning: 'تم استيراد مجموعة التكوين مع وجود تحذيرات.',
      importFailed: 'تعذر استيراد مجموعة التكوين.',
      unresolvedReferencesHeading: 'يشير الاستيراد إلى كيانات غير موجودة في هذه النسخة.',
      defaultConflictHeading: 'يتعارض الاستيراد مع كيان افتراضي في هذه النسخة.',
      unresolvedImportTitle: 'الاستيراد: مراجع غير محلولة',
      unresolvedImportDescription: 'لم تتم كتابة أي بيانات. احذف هذه المراجع من الحزمة المصدر أو أنشئ الكيانات المفقودة هنا ثم أعد المحاولة.',
      referenceLocation: 'في {path}',
      unresolvedKinds: {
        user: 'المستخدم {name}', role: 'الدور «{name}»', group: 'المجموعة «{name}»',
        status_category: 'فئة الحالة «{name}»', entity: 'الكيان «{name}»',
      },
      export: 'تصدير',
      exportTitle: 'تصدير مجموعة التكوين هذه كقالب JSON قابل للنقل',
      exportDefaultDisabled: 'لا يمكن تصدير مجموعة التكوين الافتراضية. استنسخها أولاً إذا كنت بحاجة إلى نسخة قابلة للنقل.',
      defaults: {
        configuration: { name: 'التكوين الافتراضي', description: 'مجموعة التكوين الافتراضية مع سير العمل والشاشة الأساسيين' },
        notifications: { name: 'الإشعارات الافتراضية', description: 'قواعد الإشعارات القياسية لتحديثات عناصر العمل' },
      },
    ...
    sso: {
      ...
      trustIdpEmailVerification: 'الوثوق بعناوين البريد التي يديرها الموفر',
      trustIdpEmailVerificationDesc: 'تخطي تحقق Windshift عندما لا يرسل الموفر حالة التحقق. العناوين التي يصرح الموفر بأنها غير محققة تظل بحاجة إلى التحقق.',
      idpVerificationNotEnforced: 'يتحقق Windshift من البريد غير المؤكد',
      unsafeProvisioningWarningTitle: 'تم تفعيل الثقة ببريد الموفر',
      unsafeProvisioningWarningBody:
        'يمكن ربط مستخدمي الموفر بحسابات موجودة عبر البريد عندما لا يرسل الموفر حالة التحقق. فعّل هذا فقط إذا كان الموفر يتحكم بعناوين بريد مستخدميه.',
    ...
    linkTypes: {
      ...
      nameRequired: 'الاسم مطلوب',
      failedToSave: 'تعذر حفظ نوع الرابط.',
      namePlaceholder: 'مثال: ينفّذ',
      forwardPlaceholder: 'مثال: ينفّذ',
      reversePlaceholder: 'مثال: ينفّذه',
      forwardHint: 'في الاتجاه الأمامي، اعرض أن العنصر المصدر ينفّذ العنصر الهدف',
      reverseHint: 'في الاتجاه العكسي، اعرض أن العنصر الهدف ينفّذه العنصر المصدر',
      descriptionPlaceholder: 'وصف اختياري لنوع العلاقة هذا',
      empty: 'لم يتم العثور على أنواع روابط. أنشئ النوع الأول لتفعيل العلاقات بين العناصر.',
      defaults: {
        tests: { name: 'يختبر', description: 'حالة الاختبار تختبر عنصر العمل' },
        implements: { name: 'ينفّذ', description: 'عنصر العمل ينفّذ عنصر عمل آخر' },
        dependsOn: { name: 'يعتمد على', description: 'عنصر العمل يعتمد على عنصر عمل آخر' },
        relatesTo: { name: 'مرتبط بـ', description: 'علاقة عامة ثنائية الاتجاه' },
        linksTo: { name: 'يرتبط بـ', description: 'رابط عام موجّه' },
        duplicates: { name: 'يكرّر', description: 'عنصر العمل نسخة مكررة من عنصر آخر' },
        childOf: { name: 'فرع من', description: 'علاقة تسلسل هرمي بديلة' },
        page: { name: 'صفحة', description: 'عنصر العمل يشير إلى صفحة معرفة' },
      },
    },
    statusCategories: {
      title: 'فئات الحالات',
      ...
      completed: 'مكتمل',
      nameRequired: 'الاسم مطلوب',
      failedToSave: 'تعذر حفظ فئة الحالة.',
      failedToDelete: 'تعذر حذف فئة الحالة.',
      confirmDelete: 'هل تريد حذف فئة الحالة «{name}»؟ لا يمكن التراجع عن هذا الإجراء.',
      count: 'الفئات: {count}',
      statusCount: 'الحالات: {count}',
      empty: 'لم يتم العثور على فئات حالات. أنشئ فئة الحالة الأولى للبدء.',
      ...
      defaults: {
        toDo: { name: 'للإنجاز', description: 'عمل لم يبدأ بعد' },
        inProgress: { name: 'قيد التنفيذ', description: 'عمل يجري تنفيذه حاليًا' },
        done: { name: 'مكتمل', description: 'عمل تم إنجازه' },
      },
    },
    itemTypes: {
      title: 'أنواع العناصر',
      ...
      nameRequired: 'الاسم مطلوب',
      failedToLoad: 'تعذر تحميل أنواع العناصر.',
      failedToSave: 'تعذر حفظ نوع العنصر.',
      deleteFailed: 'تعذر حذف نوع العنصر.',
      confirmDelete: 'هل تريد حذف «{name}»؟ لا يمكن التراجع عن هذا الإجراء.',
      noItemTypes: 'لم يتم تكوين أنواع عناصر بعد.',
      noConfigurationSets: 'لا توجد مجموعات تكوين',
      defaultConfiguration: 'التكوين الافتراضي',
      namePlaceholder: 'مثال: ملحمة، قصة، مهمة، خطأ',
      descriptionPlaceholder: 'وصف موجز لنوع العنصر هذا',
      levelLabel: 'المستوى {level} — {name}',
      levelOnly: 'المستوى {level}',
      levelOption: '{name} (المستوى {level})',
      defaults: {
        initiative: 'مبادرة',
        epic: 'ملحمة',
        story: 'قصة',
    ...
    hierarchyLevels: {
      ...
      failedToLoad: 'تعذر تحميل مستويات التسلسل الهرمي.',
      failedToSave: 'تعذر حفظ مستوى التسلسل الهرمي.',
      deleteFailed: 'تعذر حذف مستوى التسلسل الهرمي.',
      cannotDeleteTitle: 'لا يمكن حذف مستوى التسلسل الهرمي',
      levelOccupied: 'المستوى {level} مشغول بالفعل بواسطة «{name}».',
      negativeLevel: 'لا يمكن نقل مستوى التسلسل الهرمي إلى أقل من 0.',
      empty: 'لم يتم تكوين مستويات تسلسل هرمي بعد.',
      numericHint: 'مستوى التسلسل الهرمي الرقمي (0 = الأعلى)',
      namePlaceholder: 'مثال: مبادرة، ملحمة، قصة، مهمة',
      descriptionPlaceholder: 'وصف مختصر لمستوى التسلسل الهرمي هذا',
      createTitle: 'إنشاء مستوى تسلسل هرمي',
      editTitle: 'تعديل مستوى التسلسل الهرمي',
      confirmDelete: 'حذف «{name}»؟',
      defaults: {
        initiative: {
          name: 'مبادرة',
          description: 'عمل استراتيجي عالي المستوى يمتد عبر عدة ملاحم',
        },
        epic: {
          name: 'ملحمة',
          description: 'عنصر عمل كبير يمكن تقسيمه إلى قصص',
        },
        story: {
          name: 'قصة',
          description: 'قصة مستخدم أو ميزة تقدم قيمة',
        },
        task: {
          name: 'مهمة',
          description: 'عنصر عمل فردي أو مهمة تقنية',
        },
        activity: {
          name: 'نشاط',
          description: 'نشاط محدد ضمن مهمة',
        },
      },
    },
    modules: {

<script>
  ...
  import { User, Home, Shield, Sun, Moon, Monitor, Code2 } from '@lucide/svelte';
...
<DropdownMenu
  ...
  items={[
    ...
    { type: 'divider' },
    {
      ...
      icon: Code2,
      iconColor: '#3b82f6',
      title: t('components.userAvatar.apiDocs'),
      subtitle: t('components.userAvatar.apiDocsSubtitle'),

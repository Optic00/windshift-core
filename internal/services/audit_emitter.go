...
func emitServiceAudit(db database.Database, actor AuditActor, actionType, resourceType string, resourceID *int, resourceName string, details map[string]interface{}) {

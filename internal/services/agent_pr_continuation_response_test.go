...
func newContinuationResponseService(t *testing.T) (*AgentPRService, database.Database, *PRCommentRequest, int, int64) {
	...
	for _, statement := range []string{
		...
		`INSERT INTO users(id,email,username,first_name,last_name,is_agent) VALUES (1,'admin@example.test','admin','Admin','User',0)`,
		`INSERT INTO users(id,email,username,first_name,last_name,is_agent) VALUES (2,'agent@example.test','agent','Coding','Agent',1)`,
		`INSERT INTO scm_providers(id,slug,name,provider_type,auth_method,enabled) VALUES (1,'gh','GitHub','github','pat',1)`,
		`INSERT INTO workspace_scm_connections(id,workspace_id,scm_provider_id,enabled) VALUES (2,1,1,1)`,
		`INSERT INTO workspace_repositories(id,workspace_scm_connection_id,repository_external_id,repository_name,repository_url,default_branch,is_active) VALUES (5,2,'5','acme/repo','https://example.test/acme/repo','main',1)`,
		`INSERT INTO items(id,workspace_id,workspace_item_number,title) VALUES (10,1,10,'Continuation response')`,
		...
		`INSERT INTO workspace_agent_binding_repos(binding_id,scm_connection_id,repo_slug,repo_base_ref,is_primary) VALUES (3,2,'acme/repo','main',1)`,

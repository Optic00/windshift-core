...
// backfillPostgresTimestampTZ upgrades legacy TIMESTAMP columns to
// TIMESTAMPTZ, interpreting existing application values as UTC. It skips
// converted and Postgres-owned columns.
